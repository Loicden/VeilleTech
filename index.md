...
## Conclusion
Le Big Data occupe depuis quelques années une place de plus en plus grande dans la vie publique, et peut-être utilisé à des fins commerciaux voire politiques. Les données utilisées sont de plus la plupart du temps récupérées sans que l'utilisateur ne s'en rende compte, par "scraping" notamment, pourtant il a accepté cette récupération via les conditions d'utilisation, trop rarement lues. Pour éviter que le Big Data continue son essor en politique, il est nécessaire que de nouvelles législations soient mises en place concernant la confidentialité, la sûreté et la souveraineté de nos données, mais le lobbying des géants de la tech, qui gagnent leur argent majoritairement grâce à ces données, est très puissant. Ces transformations doivent donc nécessairement être motivées par des agents extérieurs aux entreprises, dont les gouvernements mais également les utilisateurs puisqu'ils sont les premiers concernés. Un mouvement de masse est nécessaire mais compliqué à réaliser, c'est pourquoi chacun doit faire non seulement un effort de vigilence individuel, mais aussi se faire entendre en tant que foule, via des levées de boucliers comme on a pu en voir plusieurs exemples dans cette veille.
